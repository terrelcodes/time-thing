...
Pinned tasks should appear before unpinned tasks.
A task is "Focused" if it has a due date within the next 5 days or work entries in the previous 3 days and is not completed. Focused tasks are placed at the top of the list after pinned tasks.
Pinned Projects come next, and finally unpinned projects.

In this view, projects are collapsed by default.
